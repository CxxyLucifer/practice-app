 ...
 * 单独写一个类，方便拷贝使用
 */
class QRScannerRectView extends Component<any, any> {
    static defaultProps = {
        maskColor: '#0000004D',
        cornerColor: '#22ff00',
        borderColor: '#000000',
 ...
 * 扫描界面
 */
export default class QRScannerView extends Component<any, any> {
    static propTypes = {
    ...
    constructor(props) {
        super(props);
        const myconsole: any = console;
        //通过这句代码屏蔽 YellowBox
        myconsole.disableYellowBox = true;
    }
