...
export default class InputItem extends React.Component<InputItemProps, any> {
  ...
  render() {
    ...
    const textStyle = {
      width: Theme.inputItem.fontSize * labelNumber * 1.05
    };

    const inputStyle = {
      color: error ? Theme.colors.brandError : Theme.colors.textSecondary
    };

    const extraStyle = {
      width: typeof extra === "string" && (extra as string).length > 0
        ? (extra as string).length * Theme.inputItem.fontSize
        : 0
    };
    ...
    return (
      <View
        style={[
          styles.container,
          containerStyle,
          type === "search" ? styles.containerSearch : null,
          style
        ]}
      >
        {children
          ...
          : null}
        <View
          style={[styles.inputBox, type === "search" ? styles.searchBox : null]}
        >
          <TextInput
            ref="input"
            ...
            style={[
              styles.input,
              type === "search" ? styles.inputSearch : null,
              inputStyle
            ]}
              ...
              <View>
                {typeof extra === "string"
                  ? <Text
                      ...
                      style={[
                        styles.extra,
                        type === "search" ? styles.extraSearch : null,
                        extraStyle
                      ]}
                    >
                      {extra}
